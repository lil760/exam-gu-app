...
import ca.uqac.groupe.examgu.util.FindAuthenticatedUser;
...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse getUserInfo() {
        User user = findAuthenticatedUser.getAuthenticateUser();
        return new UserResponse(user.getId(), user.getFirstName() + "" + user.getLastName(), user.getEmail(), user.getAuthorities().stream().
